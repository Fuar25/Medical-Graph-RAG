...
def _get_langchain_deps():
    ...
    return ChatPromptTemplate, ChatOpenAI, create_extraction_chain_pydantic, BaseModel
...
class AgenticChunker:
    def __init__(self, openai_api_key=None, openai_api_base=None):
        ...
        _, ChatOpenAI, _, _ = _get_langchain_deps()
        self.llm = ChatOpenAI(
    ...
    def _update_chunk_summary(self, chunk):
        ChatPromptTemplate, _, _, _ = _get_langchain_deps()
    ...
    def _get_new_chunk_summary(self, proposition):
        ...
        return (PROMPT | self.llm).invoke({"proposition": proposition}).content
    ...
    def _get_new_chunk_title(self, summary):
        ...
        return (PROMPT | self.llm).invoke({"summary": summary}).content
    ...
    def _find_relevant_chunk(self, proposition):
        ChatPromptTemplate, _, create_extraction_chain_pydantic, BaseModel = _get_langchain_deps()
        ...
        chunk_found = (PROMPT | self.llm).invoke({
